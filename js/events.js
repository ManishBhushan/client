...
function displayCollegeList() {
    ...
    $.when($.get('/getCollegeList')).done(function (_res) {
       ...
       /*
            table changes for searching and page numbers
            1. scope="col"
            2. id="mydatatable"
        ...
        */ 
        ...
        _res.college_list.forEach(function (_row) {
            ...
            let enrollProgram = (_row.is_approved != 0) ? '<div class="transaction"><a href="#" data-toggle="modal" data-id="'+ _row.college_id +'" data-target=".enrollCourseModal">Enroll Course</a></div>' 
            : '';
